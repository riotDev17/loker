		...
		<div class="container px-3" :class="[$store.app.animation]">
			...
			<div class="mt-7">
				<form class="mx-auto w-full sm:w-1/2 mb-5" action="<?= base_url('search') ?>">
					<div class=" relative">
						<input type="text" placeholder="Cari Pekerjaan..." name="fr" class="form-input shadow-[0_0_4px_2px_rgb(31_45_61_/_10%)] bg-white rounded-full h-11 placeholder:tracking-wider" id="autocompleteInput" />
