                                ...
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input id="ctnFilecv" value="<?= $this->session->userdata('file_cv') ?>" name="cvuser" type="file" class="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-primary" />
                                        </div>
