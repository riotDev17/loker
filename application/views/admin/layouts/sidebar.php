                    ...
                    <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
                        ...
                        <li class="nav-item">
                            <ul>
                                ...
                                <li class="nav-item">
                                    <a href="skill.html" class="group">
                                        <div class="flex items-center">
                                            <svg class="shrink-0 group-hover:!text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M10 6q-.825 0-1.412-.587T8 4q0-.825.588-1.412T10 2q.825 0 1.413.588T12 4q0 .825-.587 1.413T10 6m6.5 12q1.05 0 1.775-.725T19 15.5q0-1.05-.725-1.775T16.5 13q-1.05 0-1.775.725T14 15.5q0 1.05.725 1.775T16.5 18m2.4 1.3q-.55.35-1.15.525T16.5 20q-1.875 0-3.187-1.312T12 15.5q0-1.875 1.313-3.187T16.5 11q1.875 0 3.188 1.313T21 15.5q0 .65-.175 1.25T20.3 17.9l2 2q.275.275.275.7t-.275.7q-.275.275-.7.275t-.7-.275zm-7.9-.325q.375.6.887 1.1t1.113.9V21q0 .425-.288.713T12 22q-.425 0-.712-.288T11 21zM9 16v5q0 .425-.288.713T8 22q-.425 0-.712-.288T7 21V9q-1.25-.1-2.475-.275t-2.45-.45q-.425-.1-.687-.475T1.25 7q.125-.425.513-.625t.812-.1Q4.4 6.7 6.263 6.85T10 7q1.875 0 3.738-.15t3.687-.575q.425-.1.813.1T18.75 7q.125.425-.137.8t-.688.475q-1.225.275-2.45.45T13 9v1.025q-1.35.875-2.175 2.313T10 15.5v.25q0 .125.025.25z" />
                                            </svg>
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Skills</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="loker.html" class="group">
                                        <div class="flex items-center">
                                            <svg class="shrink-0 group-hover:!text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <li class="nav-item">
                                    <a href="data-pelamar.html" class="group">
                                        <div class="flex items-center">
                                            <svg class="shrink-0 group-hover:!text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <li class="nav-item">
                                    <a href="lamaran.html" class="group">
                                        <div class="flex items-center">
                                            <svg class="shrink-0 group-hover:!text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
