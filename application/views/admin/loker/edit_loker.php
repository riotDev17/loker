        ...
        <div class="main-content flex min-h-screen flex-col">
            ...
            <div class="animate__animated p-6" :class="[$store.app.animation]">
                <div>
                    ...
                    <!-- MAIN -->
                    <form action="<?= base_url('admin/loker/update') ?>" class="mt-10" method="post" id="myForm">
                        <!-- Isi formulir -->
                        <input name="id_loker" hidden class="form-control py-4" type="text" value="<?php echo $record->id_loker; ?>" required />

                        <div class=" mb-5">
                            <label for="inputLarge">Nama Pekerjaan</label>
                            <input id="inputLarge" type="text" name="nama_pekerjaan" placeholder="Masukkan Nama Pekerjaan..." class="form-input form-input-md" value="<?php echo $record->nama_pekerjaan; ?>" />
                        </div>

                        <div class="mb-5">
                            <label for="inputLarge">Nama Perusahaan</label>
                            <input id="inputLarge" type="text" name="nama_perusahaan" placeholder="Masukkan Nama Perusahaan..." class="form-input form-input-md" value="<?php echo $record->nama_perusahaan; ?>" />
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <select class="form-select" id="provinsi" name="provinsi">
                                    <option><?= strtoupper($record->provinsi) ?></option>
                                </select>
                                <select class="form-select" id="kab" name="kab">
                                    <option><?= strtoupper($record->kabupaten) ?></option>
                                </select>
                                <select class="form-select" id="kota" name="kota">
                                    <option><?= strtoupper($record->kota) ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-5">
                            <input id="inputLarge" type="text" name="lokasi" placeholder="Nama Jalan, Gedung, No.Rumah (Optional)" class="form-input form-input-md" value="<?= $record->lokasi ?>" />
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 sm:flex justify-between gap-5">
                                <?php
                                $gaji = $record->gaji;
                                if (strpos($gaji, ' - ') !== false) {
                                    $gajiArray = explode(' - ', $gaji);
                                    $gajiAwal = $gajiArray[0];
                                    $gajiAkhir = $gajiArray[1];
                                } else {
                                    $gajiAwal = $record->gaji;
                                    $gajiAkhir = '';
                                }
                                ?>
                                <input id="priceInputawal" type="text" name="gajiawal" placeholder="Mulai" class="form-input form-input-md " value="<?= $gajiAwal ?>" />
                                <input id="priceInputakhir" type="text" name="gajiakhir" placeholder="Sampai" class="form-input form-input-md " value="<?= $gajiAkhir ?>" />
                            </div>
                        </div>
                        <div class="mb-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input id="inputLarge" type="text" name="tunjangan" placeholder="Tunjangan (Optional)" class="form-input form-input-md " value="<?php echo $record->tunjangan; ?>" />
                                </div>
                                <div>
                                    <label for="inputLarge">Keuntungan</label>
                                    <input id="inputLarge" type="text" name="keuntungan" placeholder="Keuntungan (Optional)" class="form-input form-input-md " <?php echo $record->keuntungan; ?> />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input id="inputLarge" type="text" name="pengalaman" placeholder="Masukkan Minimal Pengalaman..." class="form-input form-input-md" value=" <?php echo $record->pengalaman; ?> " />
                        </div>

                        <div class="mb-5">
                            <label for="inputLarge">Usia</label>
                            <input id="inputLarge" type="number" name="usia" placeholder="Masukkan Usia..." class="form-input form-input-md" value="<?php echo $record->usia; ?>" />
                        </div>

                        <div class="mb-5">
                            <label for="jenis_kelaminSelect">Jenis Kelamin</label>
                            <select class="form-select" name="jenis_kelamin">
                                <option selected value="<?php echo $record->jenis_kelamin; ?>"><?php echo $record->jenis_kelamin; ?></option>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select selectbenefit" name="benefit[]" multiple="multiple">
                                <?php $dataarray = explode(" ", $record->benefit);
                                foreach ($dataarray as $data) {
                                    $arrayd = explode(" ", $data);
                                    $kataAcak = $arrayd[array_rand($arrayd)];
                                    echo '<option selected value= "' . $kataAcak . '">' . str_replace('_', ' ', $kataAcak) . '</option>';
                                }
                                ?>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select" name="tipe_kerja">
                                <option selected value="<?php echo $record->tipe_kerja; ?>"><?php echo $record->tipe_kerja; ?></option>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select " name="kebijakan">
                                <option selected value="<?php echo $record->kebijakan; ?>"><?php echo $record->kebijakan; ?></option>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 sm:flex justify-between gap-5">
                                <select class="form-select" id="daySelectawal" name="hari_awal">
                                    <?php
                                    $hariArray = explode('-', $record->hari_kerja);
                                    echo '<option selected value= "' . $hariArray[0] . '">' . $hariArray[0]  . '</option>';
                                    ?>
                                ...
                                <select class="form-select" id="daySelectakhir" name="hari_akhir">
                                    <?php
                                    $hariArray = explode('-', $record->hari_kerja);
                                    echo '<option selected value= "' . $hariArray[1] . '">' . $hariArray[1]  . '</option>';
                                    ?>
                                    <option value="Senin">Senin</option>
                                    <option value="Selasa">Selasa</option>
                                    <option value="Rabu">Rabu</option>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 sm:flex justify-between gap-5">
                                <?php
                                $jam_kerja = explode('-', $record->jam_kerja);
                                ?>
                                <input id="preloading-timeawal" x-data="jamawal" name="jam_awal" class="form-input" value="<?= $jam_kerja[0] ?>" />
                                <input id="preloading-timeakhir" x-data="jamakhir" name="jam_akhir" class="form-input" value="<?= $jam_kerja[1] ?>" />
                            </div>
                        </div>
                        ...
                        <div class="mb-9">
                            ...
                            <textarea name="deskripsi" style="display:none" id="tunjang"><?= $record->deskripsi ?></textarea>
                        </div>

                        <div class="mb-5">
                            <label for="pendidikanSelect">Pendidikan</label>
                            <select class="form-select" name="pendidikan">
                                <option selected value="<?= $record->pendidikan ?>"><?= $record->pendidikan ?></option>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select selectkategori" name="kategori[]" multiple="multiple">
                                ...
                                <?php endforeach; ?>
                                <?php $dataarray = explode(" ", $record->kategori);
                                foreach ($dataarray as $data) {
                                    $arrayd = explode(" ", $data);
                                    $kataAcak = $arrayd[array_rand($arrayd)];
                                    echo '<option selected value= "' . $kataAcak . '">' . str_replace('_', ' ', $kataAcak) . '</option>';
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select selectskills" name="skills[]" multiple="multiple" placeholder="Select skills">
                                <?php $dataarray = explode(" ", $record->skills);
                                foreach ($dataarray as $data) {
                                    $arrayd = explode(" ", $data);
                                    $kataAcak = $arrayd[array_rand($arrayd)];
                                    echo '<option selected value= "' . $kataAcak . '">' . str_replace('_', ' ', $kataAcak) . '</option>';
                        ...
                        <div class="mb-5" x-data="tgl">
                            ...
                            <input id="basic" name="tgl_akhir_loker" class="form-input" value="<?= $record->tgl_akhir_loker ?>" />
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            fetch(`https://kanglerian.github.io/api-wilayah-indonesia/api/provinces.json`)
                ...
                .then(provinces => {
                    var data = provinces;
                    var prov = '<option><?= strtoupper($record->provinsi) ?></option>';
    ...
    <script>
        ...
        selectProvinsi.addEventListener('change', (e) => {
            ...
            fetch(`https://kanglerian.github.io/api-wilayah-indonesia/api/regencies/${provinsi}.json`)
                ...
                .then(regencies => {
                    var data = regencies;
                    var kab = '<option><?= strtoupper($record->kabupaten) ?></option>';
                    data.forEach(element => {
        ...
        selectKab.addEventListener('change', (e) => {
            ...
            fetch(`https://kanglerian.github.io/api-wilayah-indonesia/api/districts/${kab}.json`)
                ...
                .then(districts => {
                    var data = districts;
                    var kota = '<option><?= strtoupper($record->kota) ?></option>';
                    data.forEach(element => {
