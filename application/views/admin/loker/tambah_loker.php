            ...
            <div class="mb-5">
              ...
              <select class="form-select selectskills" name="skills[]" multiple="multiple" placeholder="Select skills">
                <optgroup label="Software Skills">
                  ...
                  <option value="test_Automation">Test Automation</option>
                  <option value="jenkins">Jenkins</option>
                  <option value="travis_CI">Travis CI</option>
                  <option value="gitlab_CI">GitLab CI</option>
                  <option value="amazon_web_service">Amazon Web Services (AWS)</option>
                  <option value="Microsoft_azure">Microsoft Azure</option>
                  <option value="google_could_platform">Google Cloud Platform (GCP)</option>
                  ...
                  <option value="Adobe_After_Effects">Adobe After Effects</option>
